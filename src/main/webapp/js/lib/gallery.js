...
jQuery(function ($) {
	var G = {
		...
		open: function (d) {
			...
			d.overlay.slideDown(100, function () {
				d.container
					.css({height:0})
					.show(function () {
						d.data.slideDown(100, function () {
		...
		close: function (d) {
			...
			G.meta.slideUp(function () {
				G.image_container.fadeOut('fast', function () {
					d.data.slideUp(100, function () {
						d.container.fadeOut(100, function () {
